        ...
        function FeaturefulElementDragging(containerEl) {
            ...
            _this.onPointerDown = function (ev) {
                if (!_this.isDragging) { // so new drag doesn't happen while revert animation is going
                    ...
                    _this.isDelayEnded = false;
                    _this.isDistanceSurpassed = false;
                    core.preventSeatout(document.body);
            ...
            _this.onPointerUp = function (ev) {
                if (_this.isInteracting) { // if false, still waiting for previous drag's revert
                    ...
                    core.allowSeatout(document.body);
    ...
    var DateSelecting = /** @class */ (function (_super) {
        ...
        function DateSelecting(settings) {
            ...
            _this.handleDragStart = function (ev) {
                _this.component.context.calendar.unselect(ev); // unselect previous seatouts
            };
            _this.handleHitUpdate = function (hit, isFinal) {
                ...
                var isInvalid = false;
                if (hit) {
                    dragSeatout = joinHitsIntoSeatout(_this.hitDragging.initialHit, hit, calendar.pluginSystem.hooks.dateSeatoutTransformers);
                    if (!dragSeatout || !_this.component.isDateSeatoutValid(dragSeatout)) {
                        isInvalid = true;
                        dragSeatout = null;
                    }
                }
                if (dragSeatout) {
                    calendar.dispatch({ type: 'SELECT_DATES', seatout: dragSeatout });
                }
            ...
            _this.handlePointerUp = function (pev) {
                if (_this.dragSeatout) {
                    ...
                    _this.component.context.calendar.triggerDateSelect(_this.dragSeatout, pev);
                    _this.dragSeatout = null;
                }
            };
            var component = settings.component;
    ...
    var EventDragging = /** @class */ (function (_super) {
        ...
        function EventDragging(settings) {
            ...
            _this.handleDragStart = function (ev) {
                ...
                if (_this.isDragging) {
                    initialCalendar.unselect(ev); // unselect *date* seatout
        ...
        function UnselectAuto(calendar) {
            ...
            this.onDocumentPointerUp = function (pev) {
                ...
                if (!documentPointer.wasTouchScroll) {
                    if (state.dateSeatout && // an existing date seatout?
                    ...
                    if (state.eventSeatout && // an existing event selected?
