        ...
        function FeaturefulElementDragging(containerEl) {
            ...
            _this.onPointerDown = function (ev) {
                if (!_this.isDragging) { // so new drag doesn't happen while revert animation is going
                    ...
                    _this.isDelayEnded = false;
                    _this.isDistanceSurpassed = false;
                    core.preventSdesign(document.body);
            ...
            _this.onPointerUp = function (ev) {
                if (_this.isInteracting) { // if false, still waiting for previous drag's revert
                    ...
                    core.allowSdesign(document.body);
    ...
    var DateSelecting = /** @class */ (function (_super) {
        ...
        function DateSelecting(settings) {
            ...
            _this.handleDragStart = function (ev) {
                _this.component.context.calendar.unselect(ev); // unselect previous sdesigns
            };
            _this.handleHitUpdate = function (hit, isFinal) {
                ...
                var isInvalid = false;
                if (hit) {
                    dragSdesign = joinHitsIntoSdesign(_this.hitDragging.initialHit, hit, calendar.pluginSystem.hooks.dateSdesignTransformers);
                    if (!dragSdesign || !_this.component.isDateSdesignValid(dragSdesign)) {
                        isInvalid = true;
                        dragSdesign = null;
                    }
                }
                if (dragSdesign) {
                    calendar.dispatch({ type: 'SELECT_DATES', sdesign: dragSdesign });
                }
            ...
            _this.handlePointerUp = function (pev) {
                if (_this.dragSdesign) {
                    ...
                    _this.component.context.calendar.triggerDateSelect(_this.dragSdesign, pev);
                    _this.dragSdesign = null;
                }
            };
            var component = settings.component;
    ...
    var EventDragging = /** @class */ (function (_super) {
        ...
        function EventDragging(settings) {
            ...
            _this.handleDragStart = function (ev) {
                ...
                if (_this.isDragging) {
                    initialCalendar.unselect(ev); // unselect *date* sdesign
        ...
        function UnselectAuto(calendar) {
            ...
            this.onDocumentPointerUp = function (pev) {
                ...
                if (!documentPointer.wasTouchScroll) {
                    if (state.dateSdesign && // an existing date sdesign?
                    ...
                    if (state.eventSdesign && // an existing event selected?
