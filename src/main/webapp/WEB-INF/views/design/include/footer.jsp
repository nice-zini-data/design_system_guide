    ...
    <div class="foot">
        <div class="foot_txtBox1">
            <div class="foot_logoBox">
                <div class="footLogo">
                    <img src="/design/assets/design/images/logo/logo.svg" alt="로고" />
                </div>
                <p class="txt_n">문구<br/>
                </p>
            </div>
        ...
        <div class="t_bridgeLogo">
            <img src="/design/assets/design/images/logo/t_bridge_logo.svg" alt="T-BRIDGE 로고">
            <p class="foot_txt_font">데이터 출처: 주식회사 </p>
        </div>
