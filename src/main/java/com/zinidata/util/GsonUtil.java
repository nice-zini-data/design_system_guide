...
import com.zinidata.util.adapter.*;
...
public class GsonUtil {
    ...
    public String toJson(Object object){
        return ZiniUtil.getSpclStrCnvr(getGsonBuilder().create().toJson(object));
    }
    ...
    public String toJson(JsonOutputVo jsonOutputVo){
        return ZiniUtil.getSpclStrCnvr(getGsonBuilder().create().toJson(messageUtil.setJsonOutputVo(jsonOutputVo)));
    }

    public String toJsonAdm(JsonOutputVo jsonOutputVo){
        return ZiniUtil.escapeCharDecode(ZiniUtil.getSpclStrCnvr(convertJsonAdm(messageUtil.setJsonOutputVo(jsonOutputVo))));
    }
    ...
    public String toJsonCustomMessage(JsonOutputVo jsonOutputVo){
        return ZiniUtil.escapeCharDecode(convertJsonAdm(jsonOutputVo));
    }
